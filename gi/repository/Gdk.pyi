...
class Screen(GObject.Object):
    ...
    def get_monitor_geometry(self, monitor_num): ...
    ...
    def get_monitor_workarea(self, monitor_num): ...
...
class Cursor(GObject.Object):
    ...
    @staticmethod
    def new_from_surface(display, surface, x, y): ...
...
class Rectangle:
    ...
    x: int
    y: int
    def equal(self, other: Rectangle) -> bool: ...
    def intersect(self, other: Rectangle) -> bool: ...
    def union(self, other: Rectangle) -> bool: ...
...
class ModifierType(GObject.GFlags):
    BUTTON1_MASK: ModifierType
    BUTTON2_MASK: ModifierType
    BUTTON3_MASK: ModifierType
    BUTTON4_MASK: ModifierType
    BUTTON5_MASK: ModifierType
    CONTROL_MASK: ModifierType
    HYPER_MASK: ModifierType
    LOCK_MASK: ModifierType
    META_MASK: ModifierType
    MOD1_MASK: ModifierType
    MOD2_MASK: ModifierType
    MOD3_MASK: ModifierType
    MOD4_MASK: ModifierType
    MOD5_MASK: ModifierType
    MODIFIER_MASK: ModifierType
    MODIFIER_RESERVED_13_MASK: ModifierType
    MODIFIER_RESERVED_14_MASK: ModifierType
    MODIFIER_RESERVED_15_MASK: ModifierType
    MODIFIER_RESERVED_16_MASK: ModifierType
    MODIFIER_RESERVED_17_MASK: ModifierType
    MODIFIER_RESERVED_18_MASK: ModifierType
    MODIFIER_RESERVED_19_MASK: ModifierType
    MODIFIER_RESERVED_20_MASK: ModifierType
    MODIFIER_RESERVED_21_MASK: ModifierType
    MODIFIER_RESERVED_22_MASK: ModifierType
    MODIFIER_RESERVED_23_MASK: ModifierType
    MODIFIER_RESERVED_24_MASK: ModifierType
    MODIFIER_RESERVED_25_MASK: ModifierType
    MODIFIER_RESERVED_29_MASK: ModifierType
    RELEASE_MASK: ModifierType
    SHIFT_MASK: ModifierType
    SUPER_MASK: ModifierType
...
class DragContext:
    ...
    def set_hotspot(self, hot_x, hot_y): ...
...
class Window(GObject.Object):
    ...
    def at_pointer(): ...
    @staticmethod
    def constrain_size(geometry, flags, width, height): ...
    @staticmethod
    def new(parent, attributes, attributes_mask): ...
    @staticmethod
    def process_all_updates(): ...
    @staticmethod
    def set_debug_updates(setting): ...
    def beep(self, ): ...
    def begin_draw_frame(self, region): ...
    ...
    def coords_from_parent(self, parent_x, parent_y): ...
    def coords_to_parent(self, x, y): ...
    def create_gl_context(self, ): ...
    def create_similar_image_surface(self, format, width, height, scale): ...
    def create_similar_surface(self, content, width, height): ...
    def deiconify(self, ): ...
    def destroy(self, ): ...
    def destroy_notify(self, ): ...
    def enable_synchronized_configure(self, ): ...
    def end_draw_frame(self, context): ...
    def end_paint(self, ): ...
    ...
    def fullscreen(self, ): ...
    def fullscreen_on_monitor(self, monitor): ...
    def geometry_changed(self, ): ...
    def get_accept_focus(self, ): ...
    def get_background_pattern(self, ): ...
    def get_children(self, ): ...
    def get_children_with_user_data(self, user_data): ...
    ...
    def get_device_position_double(self, device): ...
    def get_display(self, ): ...
    def get_drag_protocol(self, ): ...
    ...
    def is_visible(self, ): ...
    def lower(self, ): ...
    def mark_paint_from_clip(self, cr): ...
    def maximize(self, ): ...
    ...
    def move_to_rect(self, rect, rect_anchor, window_anchor, anchor_hints, rect_anchor_dx, rect_anchor_dy): ...
    ...
    def set_event_compression(self, event_compression): ...
