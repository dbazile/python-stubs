...
class SignalFlags:
    RUN_FIRST: SignalFlags
    MUST_COLLECT: SignalFlags
    DETAILED: SignalFlags
    RUN_LAST: SignalFlags
    DEPRECATED: SignalFlags
    ACTION: SignalFlags
    RUN_CLEANUP: SignalFlags
    NO_HOOKS: SignalFlags
    NO_RECURSE: SignalFlags

class Binding: ...
class GInterface: ...
class InitiallyUnowned: ...
class Object:
    def bind_property(self, source_property, target, target_property, flags): ...
    def bind_property_full(self, source_property, target, target_property, flags, transform_to, transform_from): ...
    def connect(self, detailed_signal: str, handler: Callable[None], *args) -> int: ...
    def connect_after(self, detailed_signal: str, handler: Callable[None], *args) -> int: ...
